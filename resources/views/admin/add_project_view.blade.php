...
<main class="page-content">
  ...
  <div class="col-md-8 col-lg-7 mx-auto mb-5">
    <div class="mt-3"></div>
      ...
      @endif
      <form class="row g-3" method="post" enctype="multipart/form-data" action="{{Route('add_project')}}">
        @csrf
        <div class="col-12">
        ...
        <div class="col-12">
          ...
          <input type="number" class="form-control" name="amount_raised" value="{{old('amount_raised')}}"/>
        </div>
        <div class="col-12">
          <label class="form-label">Goal</label>
          <input type="number" class="form-control" name="goal" value="{{old('goal')}}"/>
        </div>
        <div class="col-12">
